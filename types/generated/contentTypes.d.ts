...
export interface ApiFussballcampFussballcamp
  extends Struct.CollectionTypeSchema {
  collectionName: 'fussballcamps';
  info: {
    displayName: 'Fu\u00DFballcamp';
    pluralName: 'fussballcamps';
    singularName: 'fussballcamp';
  };
  options: {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::fussballcamp.fussballcamp'
    > &
      Schema.Attribute.Private;
    maxAlter: Schema.Attribute.Integer;
    minAlter: Schema.Attribute.Integer;
    ort: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'SB_Fu\u00DFballcamp'>;
    preis_in_cent: Schema.Attribute.Integer;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiKontaktKontakt extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    emailniklas: Schema.Attribute.Email;
    emailrobin: Schema.Attribute.Email;
    fragentext: Schema.Attribute.Text;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::kontakt.kontakt'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    titeltext: Schema.Attribute.Text;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiStartbildStartbild extends Struct.SingleTypeSchema {
  ...
  info: {
    displayName: 'Startbild';
    pluralName: 'startbilds';
    singularName: 'startbild';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::startbild.startbild'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    schriftfarbe: Schema.Attribute.String &
      Schema.Attribute.CustomField<'plugin::color-picker.color'>;
    schriftrandfarbe: Schema.Attribute.String &
      Schema.Attribute.CustomField<'plugin::color-picker.color'>;
    startbild: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    starttext: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiSteckbriefSteckbrief extends Struct.CollectionTypeSchema {
  collectionName: 'steckbriefs';
  info: {
    displayName: 'Steckbrief';
    pluralName: 'steckbriefs';
    singularName: 'steckbrief';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    lieblingsspieler: Schema.Attribute.String;
    lieblingsverein: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::steckbrief.steckbrief'
    > &
      Schema.Attribute.Private;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    wohnort: Schema.Attribute.String;
  };
}
